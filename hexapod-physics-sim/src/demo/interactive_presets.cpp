...
static const PresetEntry kPresetTable[] = {
    {"hex-viz|hex|hex-live",
        ...
        "Chassis settles into a coherent crouch on the plane; joints should stay bounded without flicking the rig apart.",
    ...
    {"vis-servo-arm|servo-demo",
        ...
        false,
        1500},
    {"vis-servo-chain|servo-chain-2j",
        "visual: two servos in a vertical chain (tower + two links)",
        "Compare to vis-hinge-chain: servos hold commanded elbow angles under gravity; watch coupling and settle time.",
        PresetKind::Json,
        SceneModel::Default,
        ...
        false,
        1680},
    {"vis-servo-chain-0g|servo-chain-z",
        "visual: same servo chain as vis-servo-chain, zero gravity",
        "Weightless multi-servo: mainly anchor + axis alignment visible; gentle drift instead of heavy sag.",
        PresetKind::Json,
        SceneModel::Default,
        "assets/scenes/visual/vis_servo_chain.json",
        true,
        false,
        1200},
    {"vis-servo-soft|servo-soft-pd",
        "visual: soft servo (heavy error smoothing, low angle snap)",
        "Contrast to vis-servo-stiff: arm should ease toward target slowly without harsh post-step angle kicks.",
        PresetKind::Json,
        SceneModel::Default,
        ...
        false,
        1800},
    {"vis-servo-stiff|servo-stiff-snap",
        "visual: stiffer servo (higher P/D + strong angle stabilization)",
        "Contrast to vis-servo-soft: faster lock-in; watch for crisper motion and any solver fight vs vis-servo-arm.",
        PresetKind::Json,
        SceneModel::Default,
        ...
        false,
        1200},
    {"vis-servo-integral|servo-integral-bar",
        "visual: heavy horizontal bar + strong integral on one servo",
        "Static sag vs target angle 0: integral term should pull steady-state error down after a few seconds.",
        PresetKind::Json,
        SceneModel::Default,
        ...
        false,
        2400},
    {"vis-servo-y|servo-axis-y",
        "visual: servo hinge axis along +Y (swing in horizontal plane)",
        "Different axis than the Z-swing demos; plank should orbit/seek target around vertical axis through anchor.",
        PresetKind::Json,
        SceneModel::Default,
        ...
        false,
        1500},
    {"vis-servo-torsion|servo-stack-y",
        "visual: two Y-axis servos on a wide base (small staggered stack)",
        "Light multi-body column with mild target angles; good for UDP inspection of stacked servo references.",
        PresetKind::Json,
        SceneModel::Default,
