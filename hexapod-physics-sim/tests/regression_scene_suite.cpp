...
RunMetrics RunScene(SceneConfig config, const SolverVariantConfig& variant) {
    ...
    metrics.telemetry.manifoldPointRemoves = telemetry.manifoldPointRemoves;
    metrics.telemetry.manifoldPointReorders = telemetry.manifoldPointReorders;
    metrics.telemetry.manifoldQualityLow = telemetry.manifoldQualityLow;
    metrics.telemetry.manifoldQualityMedium = telemetry.manifoldQualityMedium;
    metrics.telemetry.manifoldQualityHigh = telemetry.manifoldQualityHigh;
...
std::string ToJson(const std::vector<ComparisonResult>& results) {
    const auto writeTelemetryJson = [&](std::ostringstream& out, const RunMetrics::SolverTelemetrySnapshot& t) {
        ...
        out << "          \"manifoldPointRemoves\": " << t.manifoldPointRemoves << ",\n";
        out << "          \"manifoldPointReorders\": " << t.manifoldPointReorders << ",\n";
        out << "          \"manifoldQualityBuckets\": {\n";
        out << "            \"low\": " << t.manifoldQualityLow << ",\n";
        out << "            \"medium\": " << t.manifoldQualityMedium << ",\n";
        out << "            \"high\": " << t.manifoldQualityHigh << "\n";
        out << "          },\n";
