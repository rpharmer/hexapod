...
int main(int argc, char** argv) {
    ...
    const WalkPhaseCase phases[] = {
        {"ripple_lateral_yaw_pose", {true, RobotMode::WALK, GaitType::RIPPLE, 0.14, 0.07, 1.57, 0.35, 0.0}, 900},
        {"wave_backward_yaw_pose", {true, RobotMode::WALK, GaitType::WAVE, 0.14, 0.05, 3.14, -0.30, 0.0}, 900},
        {"tripod_lateral_yaw_pose", {true, RobotMode::WALK, GaitType::TRIPOD, 0.14, 0.05, -1.57, 0.20, 0.0}, 900},
    };
