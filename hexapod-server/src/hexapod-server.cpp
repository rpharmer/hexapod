...
bool validateSchemaHeader(const toml::value& root)
{
...
bool parseTransportConfig(const toml::value& root, ParsedToml& out)
{
...
bool parseCalibrationConfig(const toml::value& root, ParsedToml& out)
{
...
void parseTuningConfig(const toml::value& root, ParsedToml& out)
{
  auto parse_int_with_fallback = [](const toml::value& cfg_root,
  ...
  auto parse_u64_with_fallback = [](const toml::value& cfg_root,
                                    const std::string& key,
  ...
  auto parse_double_with_fallback = [](const toml::value& cfg_root,
                                       const std::string& key,
...
void parseGeometryConfig(const toml::value& root, ParsedToml& out)
{
  auto parse_double_with_fallback = [](const toml::value& cfg_root,
                                       const std::string& key,
                                       double default_value,
  ...
  auto parse_double_list_with_fallback = [](const toml::value& cfg_root,
                                            const std::string& key,
  ...
  auto parse_vec3_list_with_fallback = [](const toml::value& cfg_root,
                                          const std::string& key,
