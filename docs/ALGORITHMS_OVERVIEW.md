...
2. `[ALGORITHMS_SERVER_LOCOMOTION.md](ALGORITHMS_SERVER_LOCOMOTION.md)` — end-to-end pathway, key calculations (**§18**), symbol index (**§18.14**), safety fault arbitration (**§18.15**)
