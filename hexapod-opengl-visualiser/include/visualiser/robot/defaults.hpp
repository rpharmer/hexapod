...
constexpr std::array<HexapodLegDefaults, 6> kDefaultLegs = {{
    {323.0f, 0.0f, -35.0f, -83.0f, {-0.0835f, -0.063f, -0.007f}},
    {270.0f, 0.0f, -35.0f, -83.0f, {0.0f, -0.0815f, -0.007f}},
    {217.0f, 0.0f, -35.0f, -83.0f, {0.0835f, -0.063f, -0.007f}},
    {37.0f, 0.0f, 35.0f, 83.0f, {-0.0835f, 0.063f, -0.007f}},
    {90.0f, 0.0f, 35.0f, 83.0f, {0.0f, 0.0815f, -0.007f}},
    {143.0f, 0.0f, 35.0f, 83.0f, {0.0835f, 0.063f, -0.007f}},
}};
